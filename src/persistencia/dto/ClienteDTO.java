...
public class ClienteDTO {
	...
	public ClienteDTO(String nombreyApellidos,
			String direccion, String poblacion, String codPostal,
			LocalDate fechaCarnetConducir, String digitosTC, int mesTC,
			int añoTC, int cvcTC, String tipoTC,String dni) {
		super();
		this.dni = dni;
	...
	public void setFechaCanetConducir(LocalDate fechaCarnetConducir) {
		this.fechaCarnetConducir = fechaCarnetConducir;
	}
